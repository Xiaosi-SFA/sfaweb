...
<div class="text-center mask">这是使用 <code>class="text-center"</code> 的居中容器。</div>

<center>这是一个使用 &lt;center&gt; 标签（已弃用）的示例，包含 <strong>粗体文本</strong>。</center>
...
<img src="https://via.placeholder.com/640x360" alt="placehold" style="aspect-ratio:16/9; width:100%; object-fit:cover;" />

<!-- 遮罩文字示例：带有提示的 center-preview 示例 -->
<div class="text-center center-preview">
	<div class="mask"></div>
	<div class="mask__hint">悬停查看：这是遮罩提示文本示例</div>
	<strong>遮罩下方的示例文本，默认被遮罩覆盖。</strong>
</div>